...
4.5.2Leden met expertise op het gebied van:
...
5.2.1het Ministerie van Justitie;

5.2.2het Ministerie van Onderwijs, Cultuur en Wetenschappen;
...
5.2.5het Ministerie van Volksgezondheid, Welzijn en Sport.
...
5.6.1de SEV te adviseren over projectplannen met betrekking tot:

5.6.1.1de mate waarin projectplannen aansluiten op beleid en regelgeving van de betrokken departementen;

5.6.1.2de mate waarin beleid en regelgeving van de betrokken departementen de projecten zouden kunnen ondersteunen;
...
6.3.1het team van externe deskundigen;

6.3.2de interdepartementale klankbordgroep.
...
6.4.5de kans op een geslaagde voortzetting van het project na afloop van de regeling.
...
7.5.2met projectvoorbereiding wordt in dit verband bedoeld: activiteiten die nodig zijn om het project, zoals beschreven in het projectplan, daadwerkelijk te laten starten;
