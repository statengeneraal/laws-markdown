...
Gelet op [artikel 4.4:1 van het Arbeidstijdenbesluit vervoer](../../../../../../../../../../../../../AMvB/arbeidstijdenbesluit/vervoer/BWBR0009386/README.md);
Besluit:    
...
| aanmeldingslokatie  | x  | x  |
| afmeldingstijd UTC  | x  | --- |
| afmeldingstijd LT  | x  | --- |
| afmeldingslokatie  | x  | x  |
| bemanningssamenstelling  | x  | --- |
| anders dan hetminimum  | --- | --- |
| vereiste  | --- | --- |
| tijdstip van oproep tot  | x  | --- |
| aanmelding in een  | --- | --- |
| reservetijd in UTC  | --- | --- |
| VWT en reservetijd indien  | x  | --- |
...
| aantal landingen  | x  | --- |
| grondtijd:  | x  | x  |
| verzwarende omstandigheden:  | x  | x  |
| Voor zover dit kan leiden  | x  | --- |
| tot een correctie van  | --- | --- |
| de maximale VWT:  | --- | --- |
| grondtijd:  | x  | --- |
| single pilot operaties:  | x  | --- |
| aantal landingen dag/nacht:  | x  | --- |
| aantal hoist cycles:  | x  | --- |
| vliegtijd cargo-sling:  | x  | --- |
| meldtijd LT in reservetijd:  | x  | --- |
