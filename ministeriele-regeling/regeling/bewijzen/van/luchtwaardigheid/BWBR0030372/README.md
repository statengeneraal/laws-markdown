...
Gelet op [artikel 3.24 van de Wet luchtvaart](../../../../../../wet/wet/luchtvaart/BWBR0005555/README.md), en de [artikelen 8, derde lid](../../../../../../AMvB/besluit/luchtvaartuigen/2008/BWBR0023922/README.md), [13, aanhef en onderdelen a, b, en c](../../../../../../AMvB/besluit/luchtvaartuigen/2008/BWBR0023922/README.md), en [artikel 20 van het Besluit luchtvaartuigen 2008](../../../../../../AMvB/besluit/luchtvaartuigen/2008/BWBR0023922/README.md);
Besluit:     
### §  1  
...
####Afgifte ICAO-standaard-BvL voor een luchtvaartuig geïmporteerd uit een verdragsland
...
####Afgifte ICAO-standaard-BvL voor een luchtvaartuig geïmporteerd uit een niet-verdragsland
...
####Verlenging ICAO-standaard-BvL, speciaal-BvL orphan aircraft, en herafgifte ARC

### 6.1  

####Aanvraag en verlengingstermijn
...
####Wijziging, overdracht, en vernieuwing BvL en ARC
...
####BvL-acceptatiekeuring, BvL-verlengingsinspectie, BvL-exportinspectie en AR
...
####Inhoud acceptatiekeuringen, verlengingsinspecties en exportinspecties
...
![249203](http://wetten.overheid.nl/Illustration/249203)
![249210](http://wetten.overheid.nl/Illustration/249210)
![249211](http://wetten.overheid.nl/Illustration/249211)
![249206](http://wetten.overheid.nl/Illustration/249206)
...
| BLOK ‘A’  |
|:---|
| NAAM BEDRIJF/EZT :  | BvL-V-INSPECTIERAPPORT nr.:  | (niet invullen)  nr.:  datum:  |
| --- |
| NR. ERKENNING/AOC:  |
| GEGEVENS LUCHTVAARTUIG  |
| Type Luchtvaartuig:  | Serienummer:  | Registratie  PH -  |
| Voortstuwingsinstallatie  | Type  | Serienummer  | Gebruiksgegevens  |
| Motor:  | --- | --- | --- |
| --- | --- | --- | --- |
| --- | --- | --- | --- |
| --- | --- | --- | --- |
...
| --- | --- | --- | --- |
| VERLOOPDATUM BvL:  |
| Uren na laatste BvL-V-inspectie:  Uren na laatste periodieke inspectie:  | Datum laatste BvL-V-inspectie:  Datum laatste periodieke inspectie:  |

| BLOK ‘B’  |
|:---|
| RESULTAAT INSPECTIE  |
| Plaats inspectie:  | Datum inspectie:  | Datum advies:  |
| Hierbij wordt verklaard dat de BvL-verlengingsinspectie is uitgevoerd en dat de resultaten hiervan volledig en naar waarheid zijn vermeld.  | Naam, stempel en handtekening gemachtigde/EZT:  |
...
| BLOK ‘C’  |
|:---|
| BvL-V-INSPECTIERAPPORT nr.:  | REGISTRATIE: PH-  |
| --- | JA  | NEE  | OPM  |
| 1. KWALITEIT VAN HET ONDERHOUD  |
| a.  | Voldoet het onderhoudsprogramma aan de eisen?  | --- | --- | --- |
| b.  | Voldoet de uitvoering van het onderhoud aan de eisen?  | --- | --- | --- |
| 2. TECHNISCHE STAAT  |
| a.  | Kan verklaard worden dat het luchtvaartuig geen defecten, gebreken of beschadigingen bezit, die een reparatie of belangrijke herstelling noodzakelijk maken?  | --- | --- | --- |
| b.  | Zijn eventuele defecten, gebreken of beschadigingen middels een reparatie of belangrijke herstelling door bevoegde personen of erkende instanties opgeheven?  | --- | --- | --- |
| 3. WIJZIGINGEN  |
| a.  | Zijn de ontwerpaspecten goedgekeurd?  | --- | --- | --- |
| b.  | Zijn de geluidsaspecten goedgekeurd?  | --- | --- | --- |
| c.  | Voldoet de uitvoering aan de eisen?  | --- | --- | --- |
| d.  | Is voldaan aan de meldingsverplichting voor daartoe in aanmerking komende wijzigingen?  | --- | --- | --- |
| 4. GEBRUIKSBEPERKINGEN  |
| a.  | Kan verklaard worden dat er nu geen gebruiksbeperkingen zijn overschreden?  | --- | --- | --- |
| b.  | Zijn de benodigde acties na overschrijding van gebruiksbeperkingen door bevoegde personen of erkende instanties ondernomen?  | --- | --- | --- |
| 5. AANWIJZINGEN  |
