...
####Algemene uitgangspunten voor de scenarioanalyses van marktrisico’s en verzekeringstechnische risico’s
...
| Kredietwaardigheid  | Standard & Poor’s / Fitch  | Moody’s  | AM Best  |
|:---|:---|:---|:---|
| 0  | AAA  | Aaa  | --- |
| 1  | AA  | Aa  | A++  |
| 2  | A  | A  | A  |
...
####Scenarioanalyse van het renterisico
...
| Looptijd (in jaren)  | Stijging  | Daling  |
|:---|:---|:---|
| ≤ 1  | 70%  | 75%  |
| 2  | 70%  | 65%  |
| 3  | 64%  | 56%  |
...
####Scenarioanalyse van het aandelenrisico
...
####Scenarioanalyse van het vastgoedrisico
...
####Scenarioanalyse van het kredietrisico
...
4.  Het effect op de aanwezige solvabiliteitsmarge wordt bepaald door de actuele waarde van de belegging te vermenigvuldigen met een factor uit de onderstaande tabel op basis van duur (d) en kredietwaardigheid (0 – 6, zonder rating). Indien de gemiddelde duur van een instrument kleiner is dan één jaar, wordt deze op één jaar gesteld.  ![252955](http://wetten.overheid.nl/Illustration/252955)

### §  6  

####Scenarioanalyse van het tegenpartijkredietrisico
...
a. de levensverzekeraar bepaalt voor elke vordering op herverzekeraars het te verwachten verlies bij wanbetaling (loss given default, LGD) door:  ![252970](http://wetten.overheid.nl/Illustration/252970)
...
b. de levensverzekeraar bepaalt voor elk derivaat met een risicomitigerende werking het te verwachten verlies bij wanbetaling (loss given default, LGD):  ![252971](http://wetten.overheid.nl/Illustration/252971)
...
2. 
Met de kansen op in gebreke blijven van tegenpartij voor kredietbeoordeling *j =* 0, 1, 2, 3, 4, 5 en 6 zijn gedefinieerd door: *p0 =* 0,002%, *p1 =* 0,01%, *p2 =* 0,05%, *p3 =* 0,24%, *p4 =* 1,2% en *p5 = p6 =* 4,175% berekent de verzekeraar voor *j =* 0, 1, 2, 3, 4, 5 en 6 en *h =* 0, 1, 2, 3, 4, 5 en 6 met de volgende grootheden:  ![252972](http://wetten.overheid.nl/Illustration/252972)
Met deze grootheden bepaalt de verzekeraar de standaarddeviatie *S* met  ![252973](http://wetten.overheid.nl/Illustration/252973)
en *T* met  ![252974](http://wetten.overheid.nl/Illustration/252974)
...
3.  De levensverzekeraar berekent de uitkomst van de scenarioanalyse van het in artikel 14, tweede lid, genoemde type 1 risico voor derivaten met een risicomitigerende werking en vorderingen op herverzekeraars als volgt: als *S ≤* 0,0705 *T* dan is de uitkomst 3*S*, en als *S >* 0,0705 *T* dan is de uitkomst min(5*S*; *T*).  
...
a. de scenarioanalyse van woninghypotheken met een bedrag lager dan 1 miljoen euro zonder Nationale Hypotheek Garantie wordt bepaald als:  ![252975](http://wetten.overheid.nl/Illustration/252975)
waarbij  ![252976](http://wetten.overheid.nl/Illustration/252976)
...
c. de scenarioanalyse van leningen aan het Midden- en Kleinbedrijf zonder kredietbeoordeling wordt bepaald als:  ![252977](http://wetten.overheid.nl/Illustration/252977)
Met  ![252978](http://wetten.overheid.nl/Illustration/252978)
...
####Scenarioanalyses van de verzekeringstechnische risico’s
...
####Aggregatie van de uitkomsten van de scenarioanalyses

### Artikel  20  

De levensverzekeraar berekent het geaggregeerde resultaat *AR* van de uitkomsten van de scenarioanalyses als: ![252982](http://wetten.overheid.nl/Illustration/252982)
![252979](http://wetten.overheid.nl/Illustration/252979)
