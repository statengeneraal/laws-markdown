...
Gelet op [artikel 193b, vierde lid, van het Vissersvaartuigenbesluit](../../../../../../../../KB/vissersvaartuigenbesluit/BWBR0004607/README.md);
Besluit:    
###§ 1 
...
i.geluiddrukniveau: een maat voor het geluidniveau, behorende bij een bepaalde frequentie, op een logaritmische schaal weergegeven door:  L = 20log(p/po) dBwaarin:

p = de effectieve waarde van de gemeten geluiddruk tussen 20 Hz en 20 kHz,

p<sub>o</sub> = referentiewaarde = 20*10-6 pascal.
