...
* alle gevallen van buitenlandse corruptie als bedoeld onder C die niet door de Rijksrecherche zijn onderzocht;   Meldingen dienen in beginsel, net als bij de aanvraag inzet Rijksrecherche, gedaan te worden bij de COvJ-RR via het zgn. ‘Zaaksformulier CCR’.<sup> 7 Het Zaaksformulier CCR is te vinden op OMtranet/JKS/Kennisdomeinen/Rijksrecherche/formulieren. </sup>Indien op een parket dienaangaande een eigen registratie wordt gevoerd kan worden volstaan met periodieke toezending aan de COvJ-RR. Voorwaarde is dan wel dat die registratie minimaal de volgende elementen bevat: 
