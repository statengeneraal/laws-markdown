...
1. gemiddelde tijd (minuten per zorgmoment<sup> 2 Op een dag kunnen meerdere zorgmomenten plaatsvinden. </sup> x aantal malen per dag/week), waarbij in bepaalde gevallen ook de aanwezigheid om interventies te kunnen verrichten kan worden meegenomen;  
...
– eveneens vaststaat dat verzekerde die zorg in de betreffende periode heeft ingekocht en daadwerkelijk heeft ontvangen.   Ten slotte kan de ingangsdatum van het indicatiebesluit ook vóór de datum van het indicatiebesluit liggen, als er sprake is van bijzondere omstandigheden in een concreet geval<sup> 6 Conform de uitspraak van de Centrale Raad van Beroep, via www.rechtspraak.nl te vinden met ECLI:NL:CRVB:2009:BK1592 </sup>. Hiervan is bijvoorbeeld sprake in de volgende situaties: bij aanvragen voor zorg aansluitend aan geriatrische revalidatie, bij beëindiging van de forensische status van een verzekerde die AWBZ-zorg behoeft, en na het af- of toewijzen van een status bij asielzoekers. In deze gevallen is er sprake van een plotselinge wijziging in de situatie van de verzekerde. Als op datum aanvraag al zorg wordt verleend beslist het CIZ binnen twee weken. Ingangsdatum is de datum dat de zorg gestart is. 
...
g. welk cliëntprofiel het beste bij de zorgvrager past.’   Voor dit onderzoek wordt een uniform afwegingskader gehanteerd: het ‘trechtermodel’. In schema:  ![253039](http://wetten.overheid.nl/Illustration/253039)
...
####Doelstelling functie<sup> 15  Gebaseerd op het AWBZ-kompas van CVZ  </sup> 
...
| 2.1  | Persoonlijke zorg voor tanden, haren, nagels, huid  | • Zorg voor tanden  • Zorg voor haren  • Zorg voor nagels  • Scheren  | 5  5  5  10  | 2x  1x  1x (per week)  1x  |
...
####Doelstelling functie<sup> 17  Gebaseerd op het AWBZ-kompas van CVZ.  </sup> 
...
De gemiddelde tijden zijn basisminuten voor verzekerden die zich ‘normaal’ kunnen bewegen, meewerken, geen gedragsproblemen hebben, enzovoort. De gemiddelde tijd bevat niet alleen de tijdbesteding die direct gemoeid is met de directe zorg/handeling, maar ook het binnenkomen, gedag zeggen, handen wassen, het zorgdossier kort inkijken of bijwerken en het vertrekken (indirecte zorg). Als meerdere handelingen/activiteiten tijdens hetzelfde zorgmoment worden uitgevoerd, dan is sprake van ‘samenvallende activiteiten’. Daarvoor wordt in totaal minder tijd geïndiceerd, omdat de zorg efficiënter wordt geboden. Bij een enkelvoudige activiteit wordt de totale gemiddelde tijd als basis genomen. Bij meerdere activiteiten wordt van elke activiteit 3,5 minuut indirecte tijd in mindering gebracht en per zorgmoment wordt vervolgens 3,5 minuut indirecte tijd weer opgeteld. De gemiddelde tijd van de indirecte zorg is ontleend aan het onderzoeksrapport van bureau HHM<sup> 18 ‘Onderzoek naar tijdnormen voor activiteiten en handelingen van de functies PV en VP’, oktober 2007, bureau HHM. </sup>. De omvang is ook inclusief het schoonhouden van apparatuur en hulpmiddelen. De gemiddelde tijden kunnen bij kinderen verschillen in vergelijking met die van volwassenen. Voor thuisbeademing geldt een andere wijze van omvangbepaling (zie hoofdstuk 5).  
...
####Doelstelling functie<sup> 21  Gebaseerd op het AWBZ-kompas van CVZ.  </sup> 
...
1. Als een verzekerde vanuit een voorliggende voorziening geen volledige werkweek of geen (aangepaste vormen van) arbeid heeft.  

2. Als een verzekerde niet leerplichtig is en geen onderwijs volgt. Bij verzekerden die op grond van hun beperkingen buiten schooltijden een gestructureerd dagprogramma en toezicht nodig hebben, is deze zorg onderdeel van de samenhangende zorg binnen het geïndiceerde ZZP. Deze zorg wordt bij een verzekerde die onderwijs volgt zeven dagen per week geboden, buiten de onderwijsuren. Er is dan ook geen sprake van (AWBZ-) dagbesteding vanwege schoolvakanties, ziekteperioden en dergelijke.  

3. Als de verzekerde is aangewezen op dagbesteding met als doel een andersoortige vorm van dagstructurering dan arbeid of school (denk aan 65-plussers) en tevens zelfredzaamheid, cognitieve capaciteiten en vaardigheden zoveel mogelijk te handhaven en/of gedragsproblematiek te reguleren.   
