...
The States signatory to the present ConventionNoting that the Warsaw Convention does not contain particular rules relating to international carriage by air performed by a person who is not a party to the agreement for carriageConsidering that it is therefore desirable to formulate rules to apply in such circumstancesHave agreed as follows:
