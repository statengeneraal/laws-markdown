...
The Parties to this Protocol, Being Parties to the Convention on the Contract for the International Carriage of Goods by Road (CMR), done at Geneva on 19 May 1956, Desirous of supplementing the Convention in order to facilitate the optional making out of the consignment note by means of procedures used for the electronic recording and handling of data,   Have agreed as follows:    
