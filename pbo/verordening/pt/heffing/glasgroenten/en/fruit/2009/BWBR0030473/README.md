...
| c. cultuurgrond:  | beteelde grond, braakland, de oppervlakte van de grond die gemoeid is met het gebruik van elk ander groeimedium met behulp waarvan de in artikelen 4  en 5  genoemde gewassen of producten kunnen worden geteeld, of ten tijde van het tijdvak als bedoeld in de Regeling Landbouwtelling, nog niet beteelde grond waarbij een teelt voor eind augustus wordt ingezet;  |
...
De heffing naar de grondslag grondgebruik voor glasgroenten wordt berekend naar de oppervlakte van de bij onderneming behorende cultuurgrond en bedraagt voor:  

| --- | --- |
|:---|:---|
| aubergine, komkommer, paprika en tomaten  | € 2,72 per are  |
| overige glasgroenten  | € 1,52 per are  |

### Artikel  5  

De heffing naar de grondslag grondgebruik voor fruit wordt berekend naar de oppervlakte van de bij onderneming behorende cultuurgrond en bedraagt voor:  

| --- | --- | --- | --- |
|:---|:---|:---|:---|
| a.  | groep 32  | cultuurgrond in gebruik voor de teelt in de open grond van appelen:  | € 6,63 per ha;  |
| b.  | groep 33  | cultuurgrond in gebruik voor de teelt in de open grond van peren:  | € 11,22 per ha;  |
| c.  | groep 34  | cultuurgrond in gebruik voor de teelt in de open grond van klein fruit:  | € 27,54 per ha  |
| d.  | groep 34a  | cultuurgrond in gebruik voor de teelt in open grond van blauwe bessen:  | € 27,54 per ha  |
| e.  | groep 35  | cultuurgrond in gebruik voor de teelt in de open grond van overige pit- en steenvruchten:  | € 12,75 per ha;  |
| f.  | groep 36  | cultuurgrond in gebruik voor de teelt in de open grond van zwarte bessen en zure kersen:  | € 3,83 per ha  |
| g.  | groep 37  | cultuurgrond in gebruik voor de teelt onder glas van fruit:  | € 0,82 per are  |

### Artikel  6  

1.  Voor de toepassing van artikel 4 en 5, wordt onder de bij de onderneming behorende cultuurgrond mede verstaan cultuurgrond die: 
...
2.  Voor de toepassing van artikel 4 en 5, wordt cultuurgrond gerekend naar de gemeten maat.   
3.  Voor de toepassing van alle groepen van artikel 4 en groep 60 van artikel 5, worden gedeelten van een are belast in evenredigheid met de voor die groepen bedoelde bedragen. Gedeelten van een are worden naar beneden afgerond tot een veelvoud van centiaren (ofwel vierkante meters).   
4.  Voor de toepassing van artikel 5, worden met betrekking tot de groepen 32 tot en met 36, gedeelten van een hectare belast in evenredigheid met de voor die groepen bedoelde bedragen. Gedeelten van een hectare worden naar beneden afgerond tot een veelvoud van aren.   
...
Indien uit de ter beschikking gekomen gegevens blijkt dat de verstrekking van de gegevens of een raming als bedoeld in artikel 7, niet in overeenstemming is met de werkelijkheid, kan een opgelegde heffing aan de hand van deze gegevens worden herzien en opnieuw worden opgelegd.  
...
Deze verordening wordt aangehaald als: Verordening PT heffing glasgroenten en fruit 2009.  
