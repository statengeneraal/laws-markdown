...
##Verordening van het Hoofdbedrijfschap Agrarische Groothandel van 12 november 2009, houdende regels ter zake van de heffing voor het jaar 2010, op te leggen aan de onder het HBAG ressorterende ondernemers die de groothandel en/of het bedrijf van tussenpersoon in pootaardappelen, consumptie en/of voeraardappelen uitoefenen (Verordening HBAG financieringsheffing aardappelen 2010)
...
f)exporteur:een ondernemer die de groothandel in aardappelen uitoefent en in dat kader aardappelen in Nederland koopt en deze in het buitenland koopt en deze in Nederland verkoopt;
...
1. De ondernemer is ten behoeve van de huishoudelijke uitgaven van respectievelijk de commissie pootaardappelen en de commissie consumptie- fabrieks- en voeraardappelen voor elke hieronder sub a t/m f respectievelijk sub g t/m l vermelde functie die hij op enig tijdstip in het kalenderjaar 2010 uitoefent aan het hoofdbedrijfschap verschuldigd het hieronder vermelde bedrag aan heffing over zijn omzet in de periode van 1 juli 2009 tot 1 juli 2010;
...
| --- | --- |500 - |1.000 ton: |€ |276,-- |
| --- | --- |≥ |1.000 ton: |€ |368,-- |
|b) |tussenpersoon in pootaardappelen en |0 - |20 ton: |€ |73,-- |
|c) |makelaar in pootaardappelen: |20 - |500 ton: |€ |184,-- |
| --- | --- |≥ |500 ton: |€ |276,-- |
|d) |groothandelaar in pootaardappelen: |0 - |20 ton: |€ |73,-- |
| --- | --- |20 - |500 ton: |€ |184,-- |
| --- | --- |500 - |1.000 ton: |€ |276,-- |
| --- | --- |1.000 - |2.000 ton: |€ |460,-- |
| --- | --- |≥ |2.000 ton: |€ |644,-- |
|e) |exporteur van pootaardappelen: |0 - |20 ton: |€ |73,-- |
| --- | --- |≥ |20 ton: |€ |184,-- |
| --- | --- |vermeerderd met € 0,29 per ton |
|f) |importeur van pootaardappelen: |0 - |20 ton: |€ |73,-- |
| --- | --- |20 - |500 ton: |€ |184,-- |
| --- | --- |500 - |1.000 ton: |€ |276,-- |
| --- | --- |≥ |1.000 ton: |€ |368,-- |
|g) |tussenpersoon in consumptieaardappelen: |0 - |20 ton: |€ |100,-- |
| --- | --- |20 - |500 ton: |€ |200,-- |
| --- | --- |≥ |500 ton: |€ |300,-- |
|h) |makelaar in consumptieaardappelen: |1 - |20 ton: |€ |100,-- |
| --- | --- |20 - |500 ton: |€ |200,-- |
| --- | --- |500 - |2.500 ton: |€ |300,-- |
| --- | --- |2.500 - |10.000 ton: |€ |400,-- |
| --- | --- |≥ |10.000 ton: |€ |500,-- |
|i) |groothandelaar in consumptieaardappelen: |1 - |20 ton: |€ |100,-- |
|j) |importeur van consumptieaardappelen: |20 - |500 ton: |€ |400,-- |
| --- | --- |500 - |2.500 ton: |€ |600,-- |
| --- | --- |2.500 - |10.000 ton: |€ |700,-- |
| --- | --- |≥ |10.000 ton: |€ |900,-- |
|k) |exporteur van consumptieaardappelen: |1 - |20 ton: |€ |100,-- |
| --- | --- |20 - |500 ton: |€ |400,-- |
| --- | --- |500 - |2.500 ton: |€ |800,-- |
| --- | --- |2.500 - |10.000 ton: |€ |1.400,-- |
| --- | --- |10.000 - |20.000 ton: |€ |2.600,-- |
| --- | --- |20.000 - |30.000 ton: |€ |3.000,-- |
| --- | --- |≥ |30.000 ton: |€ |3.000,-- |
|l) |handelaar in voeraardappelen: |1 - |20 ton: |€ |100,-- |
| --- | --- |20 - |500 ton: |€ |200,-- |
| --- | --- |≥ |500 ton: |€ |300,-- |
