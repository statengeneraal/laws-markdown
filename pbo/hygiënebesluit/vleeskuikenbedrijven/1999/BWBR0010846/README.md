...
Dit werkvoorschrift beschrijft de mestmonstername zoals voorgeschreven is in het kader van het onderzoek naar Salmonella bij vleeskuikens voor het afleveren.De monsters worden genomen door of namens de eigenaar. De monstername moet plaatsvinden volgens methode A. of via methode B.
...
####Tracerings-, monitorings- en bestrijdingplan
...
| --- | --- |
|:---|:---|
|1<sup>e</sup> kolom |Nummer van desbetreffende artikel uit de "[Verordening Hygiëne- voorschriften Pluimveehouderij 1999](../../../../../pbo/verordening/hygiënevoorschriften/pluimveehouderij/1999/BWBR0010849/README.md)". Een sterretje (*) betekent dat de vraag betrekking heeft op dit artikel en dat het bedrijf daar aan moet voldoen. |
...
|*** |A |1. Hoevaak gaat er iemand (behalve uzelf en gezinsleden) van buiten het bedrijf naar binnen? Schat dit eens in per week. U kunt denken aan personeel; voorlichter; ongediertebestrijder; handelaar; dierenarts, vang/entploegen, chauffeur voer, chauffeur eieren, klanten die eieren komen kopen; etc. |0-10 |10-50 |>50 |
...
| --- |A |4. Is er een ontsmettingsbak of laarzen- reiniger met ontsmettingsmiddel aanwezig? |Ja | --- |Nee, n.v.t. |
...
| --- |A |3. Hoe wordt er ontsmet? |Stomen |M.b.v. |Niet |
| --- | --- | --- | --- |fogg/ pannen | --- |
...
|*** |A |2. Hoeveel ratten signaleert u per week? |0 | --- |1 of |
| --- | --- | --- | --- | --- |meer |
...
| --- |A |5. Komen er tempexkevers op uw bedrijf |Nooit |Soms |Vaak |
| --- | --- |voor? Of spekkevers? (aangeven per stal) | --- | --- | --- |
...
|A |2. Waar worden de kadavers opgeslagen? |Gesloten kadaver- ton |Open ton,afge- sloten ruimte |Open ton |
...
|*6.10* |*C/D* |*Het tracerings-, monitorings- en* | --- |*Voldoet* |*Voldoet* |
| --- | --- |*bestrijdingsplan dient te worden opgesteld in de periode tussen de uitslag van de monstername en het plaatsen van een volgend koppel pluimvee.* | --- | --- |*niet* |
...
| --- | --- |*Onderzoek:* | --- | --- |Nee |
|* |A |2. Is er na het reinigen en ontsmetten van de stal een zgn. swabonderzoek uitgevoerd, nu bij de uitgangscontrole een besmetting met Salmonella is vastgesteld? | --- |Ja | --- |
