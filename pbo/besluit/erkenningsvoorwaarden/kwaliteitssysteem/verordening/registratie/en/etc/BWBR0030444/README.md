...
Gelet op artikel 4, eerste lid, van de Verordening registratie en verantwoording antibioticagebruik kalversector (PVV) 2011;
Besluit:     
### §  1  
...
1.  In dit besluit wordt aangesloten bij de definities, zoals gegeven in de Verordening registratie en verantwoording antibioticagebruik kalversector (PVV) 2011 en wordt voorts verstaan onder:  

| --- | --- | --- | --- |
|---|---|---|---|
| a.  | verordening  | :  | Verordening registratie en verantwoording antibioticagebruik kalversector (PVV) 2011;  |
| b.  | erkenning  | :  | rerkenning als bedoeld in artikel 4, eerste lid, van de verordening.  |
...
d. de controle-instantie gehouden is binnen een maand na de verrichte controle als bedoeld is artikel 5 van de verordening een rapport van bevindingen op te maken en beschikbaar te houden;  
