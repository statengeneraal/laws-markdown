...
4.  Indien de arena of de uitvoering van de filmproductie zodanig complex is dat voor het verder uitwerken van het scenario de betrokkenheid van een team van creatieve en technische specialisten noodzakelijk is om concreet te onderzoeken hoe verfilming mogelijk is, kan het bestuur besluiten hiervoor een extra ontwikkelingsbijdrage beschikbaar te stellen.  

### Artikel  15  

####– besteding scenario-ontwikkeling –

De subsidie is primair bestemd voor (de) scenarist(en), eventueel betrokken *scriptcoach*es en coauteurs, die het scenario, dan wel een of meerdere versies daarvan, ten behoeve waarvan deze bijdrage is verstrekt, vervaardigen, uitgezonderd indien een bijdrage op grond van Artikel 14 lid 4 wordt toegekend. 
...
– camera tests en/of het storyboard  
