...
c. de volgende functionaris, werkzaam bij de Divisie Registratie en Informatie, te weten: 
...
d. het Hoofd OVR (Ontwikkeling Voertuigreglementering);  

e. het Hoofd Communicatie (Afdeling Communicatie);  

f. het Hoofd SEO (Strategie en Externe Ontwikkelingen);  

g. de volgende functionarissen, werkzaam bij de Divisie Voertuigtechniek, te weten: 

1. de Manager B&I (Bedrijfsvoering en Innovatie);  

2. de Manager TTV (Toelating Toezicht Voertuigen);  

3. de Manager KIM (Kennis- en Informatiemanagement);  

4. de Manager APK (Algemene Periodieke Keuringen);  

5. de Manager IK (Individuele Keuringen);    
...
d. de volgende functionarissen werkzaam bij het bedrijfsproces APK: 
...
e. de volgende functionarissen werkzaam bij het bedrijfsproces IK: 

1. de Clustermanagers    

f. de volgende functionarissen werkzaam bij bedrijfsproces KIM: 
...
c. het Hoofd Facilitair Bedrijf;  
...
g. het Hoofd OVR (Ontwikkeling Voertuigreglementering);  
...
b. de Manager Beoordeling en Toezicht.   
...
De stukken die door de in de artikelen 1 tot en met 10 genoemde functionarissen op grond van deze regeling worden ondertekend, vermelden aan het slot: De directie van de RDW, namens deze, Gevolgd door functieaanduiding, handtekening en naam van de betrokken functionaris. 
