...
Indien een CCP is gestopt met het berekenen van de K<sub>CCP</sub> in de zin van artikel 308, derde lid, van de CRR, dan mogen instellingen de alternatieve formule uit artikel 310 van de CRR gebruiken om het vereiste eigen vermogen voor hun handelspositie op de CCP en de bijdrage aan het faillissementsfonds voor de CCP zoals omschreven in artikel 311, tweede lid, van de CRR te berekenen, mits aan de volgende vereisten is voldaan: 

a. de CCP heeft conform artikel 311, eerste lid, onderdeel a, van de CRR aan de instelling gemeld dat de CCP gestopt is met het berekenen van de K<sub>CCP</sub>; en  
