...
### * *Aanvullende bekwaamheidseisen inhuur* * 
...
####Eindtermen kenniselementen basisbekwaamheid 2013

|  *Bijlage B Ia*   |  *Eindtermen kenniselementen basisbekwaamheid (boa-getuigschrift)*   |--- |  *Hoofdtaak*   |  *Taak*   |  *Deeltaak*   |  *Kenniselementen*   |
|:---|:---|:---|:---|:---|:---|:---|
...
| --- | --- | --- | --- |
| --- | 1.2. een AMvB  | --- | – art. 89, lid 1 GW  |
| --- | --- | --- | • algemeen verbindende voorschriften van de regering  |
| --- | --- | --- | --- |
| --- | 1.3. een provinciale verordening  | --- | – art. 127 GW  • bevoegdheid Provinciale Staten tot vaststellen Provinciale verordeningen  |
| --- | --- | --- | --- |
| --- | --- | --- |  *Provinciale Staten*   |
| --- | --- | --- | – art. 125, lid 1 GW  |
| --- | --- | --- | • hoofd provincie  |
...
| --- | --- | --- | --- |
| --- | 1.4. een gemeentelijke verordening  | --- | – art. 127 GW  • bevoegdheid gemeenteraad tot vaststellen gemeentelijke verordeningen  |
| --- | --- | --- | --- |
| --- | --- | --- |  *gemeenteraad*   |
| --- | --- | --- | – art. 125, lid 1 GW  |
...
| --- | bepaalde in het [Wetboek van](../../../../../../wet/wet/van/15/januari/1921/BWBR0001903/README.md)  | --- | --- |
| --- |  [Strafvordering](../../../../../../wet/wet/van/15/januari/1921/BWBR0001903/README.md)   | --- | – art. 142 WvSv  |
| --- | --- | --- | --- |
| --- | 2.2. overeenkomstig de bepalingen  | --- | --- |
| --- | uit het [Besluit buitengewoon](../../../../../../AMvB/besluit/buitengewoon/opsporingsambtenaar/BWBR0007013/README.md)  | --- | --- |
| --- | [opsporingsambtenaar](../../../../../../AMvB/besluit/buitengewoon/opsporingsambtenaar/BWBR0007013/README.md) m.b.t.  | --- | --- |
| --- | --- | 2.2.1. de voorwaarden voor het verkrijgen van opsporingsbevoegdheid  | – art. 2, art. 16 lid 1 en lid 2, art. 17 en art. 19 Besluit BOA  |
| --- | --- | --- | --- |
| --- | --- | 2.2.2. het verlenen van opsporingsbevoegdheid  | – artt. 3, 4 en 10 Besluit BOA  |
| --- | --- | --- | --- |
| --- | --- | 2.2.3. het vervallen van opsporingsbevoegdheid  | – art. 8 Besluit BOA  – art. 35, lid 1 en lid 2 Besluit BOA  |
| --- | --- | --- | --- |
| --- | --- | 2.2.4. de instructie aan de buitengewoon opsporingsambtenaar  | – hoofdstuk V Besluit BOA  – de herkenbaarheid van de BOA  • insigne  |
| --- | --- | --- | --- |
| --- | --- | --- |  *géén examenstof:*   |
...
| --- | --- | --- | --- |
| --- | --- | 2.2.5. het toezicht over de buitengewoon opsporingsambtenaren  | – art. 32 Besluit BOA  • toezicht  – art. 36, art. 37 lid 1, art. 38 en art. 39 Besluit BOA  |
...
| --- | --- | --- | --- |
| --- | --- | 2.3.1. de taak van de politie  | – art. 3 Politiewet 2012  |
| --- | --- | --- | --- |
| --- | --- | 2.3.2. het begrip ‘politie’  | – art. 2 Politiewet 2012 en art. 49, lid1 en lid 2 sub a Politiewet 2012  |
| --- | --- | --- | --- |
| --- | --- | 2.3.3. de organisatie van de politie  | – art. 25 Politiewet 2012  |
...
| --- |
| --- | --- | 2.3.4. het werkgebied van de politie  | – art. 6 Politiewet 2012  |
| --- | --- | --- | --- |
| --- | --- | 2.3.5. de bevoegdheden van de politie  | – art.7 lid 1, lid 3, lid 5 en lid 7 Politiewet 2012  |
| --- | --- | --- | • BOA moet zijn aangewezen  |
| --- | --- | --- | • uitoefening bevoegdheden dient in verhouding tot beoogd doel redelijk en gematigd te zijn  |
| --- | --- | --- | --- |
| --- | --- | 2.3.6. het gezag over de politie  | – art. 12 en art. 15 Pw2012 en art. 39, lid 2 Wet veiligheidsregio’s  |
| --- | --- | --- | • voorzitter van de veiligheidsregio  |
| --- |
| --- | --- | 2.3.7. het toezicht over de politie  | – art. 65 lid 1 sub a en b Politiewet 2012  |
| --- | --- | --- | • IOOV  |
| --- | --- | --- | – art. 41, lid 1 Wet veiligheidsregio’s  |
| --- | --- | --- | • CdK ziet toe op samenwerking  |
| --- | --- | --- | --- |
| --- | 2.4. v.w.b. het opsporen van strafbare feiten  | --- | – Minister van Veiligheid en Justitie  |
...
| --- | --- | --- | --- |
| --- | --- | 3.2.1. schending van bijzondere ambtsplicht  | – art. 44 WvSr  |
| --- | --- | --- | --- |
| --- | --- | 3.2.2. omkoping  | – art. 362, lid 1 en art. 363, lid 1 WvSr  |
| --- | --- | --- | – art. 177, lid 1 WvSr  |
| --- | --- | --- | – art. 177a, lid 1 WvSr  |
| --- | --- | --- | --- |
| --- | --- | 3.2.3. meineed  | – art. 207, lid 1, lid 2 en lid 3 WvSr  |
| --- | --- | --- | --- |
| --- | --- | 3.2.4. valsheid in geschrift  | – art. 225, lid 1 en 2 WvSr  |
| --- | --- | --- | --- |
| --- | --- | 3.2.5. huisvredebreuk  | – art. 370, lid 1 WvSr  |
| --- | --- | --- | – art. 138, lid 1 WvSr  |
| --- | --- | --- | --- |
...
| De buitengewoon opsporingsambtenaar  | --- | --- | --- |
| --- | --- | --- | --- |
| 4. verzamelt en/of ontvangt gegevens m.b.t. mogelijk strafbare feiten tot opsporing waarvan hij bevoegd is  | --- | --- |  *Begrippen*   |
...
| --- | door het toepassen van verworven kennis en inzicht in algemene (begrips)bepalingen m.b.t.  | --- | – begrip ‘materieel strafrecht’ vs ‘formeel strafrecht’  |
...
| --- | --- | --- | • keuren  |
| --- | --- | --- | --- |
| --- | 5.1. het legaliteitsbeginsel  | --- | – art. 16 GW  |
| --- | --- | --- | – art. 1 WvSr  |
| --- | --- | --- | – art. 91 WvSr (slotbepaling)  |
| --- | --- | --- | --- |
| --- | 5.2. de toepasselijkheid van de Nederlandse strafwet  | --- | – artt. 2 en 3 WvSr  |
| --- | --- | • territorialiteitsbeginsel  |
| --- | --- | --- | • vlagbeginsel  |
| --- | --- | --- | --- |
| --- | 5.3. een feit als zijnde een strafbaar feit  | --- | – definitie strafbaar feit  |
...
| --- | --- | --- | --- |
| --- | 5.4. wettelijke strafuitsluitingsgronden  | --- | – art. 39 WvSr  |
| --- | --- | • ontoerekenbaarheid  |
| --- | --- | --- | – art. 40 WvSr  |
| --- | --- | --- | • overmacht  |
| --- | --- | --- | – art. 41 WvSr  |
...
| --- | --- | --- | --- |
| --- | 5.5. poging en voorbereiding  | --- | – art. 45, lid 1 en lid 2, art. 46 lid 1 en  |
| --- | --- | --- | art. 46b WvSr  |
...
| --- | --- | --- | --- |
| --- | 8.3. op grond van kennis omtrent de Procureur-generaal bij de Hoge Raad  | --- | – art. 117, lid 1 GW  |
...
| --- | --- | 8.4.1. m.b.t. de onderscheiden rechterlijke colleges  | – art. 2 Wet RO  |
| --- | --- | • Rechtbanken  |
| --- | --- | --- | • Gerechtshoven  |
| --- | --- | --- | • Hoge Raad  |
...
| --- | --- | --- | • kantonrechter  |
| --- | --- | --- | --- |
| --- | --- | 8.4.2. m.b.t. de competentie van rechterlijke colleges (alleen rechtsprekende rechter) in strafzaken  |  *Absolute competentie*   |
| --- | --- | • begrip  |
| --- | --- | – art. 119 GW  |
| --- | --- | --- | • Hoge Raad  |
| --- | --- | --- | – art. 76, lid 1 Wet RO  |
...
| --- | --- | --- | --- |
| --- | --- | 8.4.3. m.b.t. de waarborgen voor een deugdelijke rechtspraak  | – art. 17 GW  |
...
| --- | --- | --- | --- |
| --- | --- | 8.4.4. m.b.t. de rechterlijke beslissing  | – artt. 338 en 339 WvSv  |
...
| --- | --- | --- | • herziening  |
| --- | --- | --- | --- |
| 9. doet het proces-verbaal toekomen aan de juiste functionaris  | --- | --- | – art. 156 lid 1 WvSv  |
| --- | --- | --- | --- |
| 10. De boa draagt bij constateringen van onregelmatigheden en overtredingen zorg voor acceptatie van de opgelegde sanctie  | --- | --- | Verder uitgewerkt in bijlage B Ib  |
| --- | --- | --- | --- |
| 11. De boa waarborgt eigen veiligheid,veiligheid van de burger en omstanders  | --- | --- | Verder uitgewerkt in bijlage B Ib  |

### Bijlage  B-IB  

####Exameneisen en prestatie-indicatoren gespreks- en benaderingstechnieken

De onderstaande exameneisen zijn een uitwerking van taak 7, 10 en 11 zoals beschreven in de Eindtermen basisexamen Buitengewoon opsporingsambtenaar. Grijze regels zijn de exameneisen, te lezen als: De kandidaat…  

| vaardigheidstoets  | bereidt zich voor.  |
|:---|:---|
|  *Resultaat*   | Taak, visie en advies wat betreft de uitvoering van de werkzaamheden ontvangen/gevraagd.  |
|  *Prestatie-indicatoren*   | Neemt informatie op en past deze gericht toe  |
| Bestudeert (indien nodig) bijbehorende wet en regelgeving.  |
| Geeft aan hoe in gegeven situatie gehandeld kan worden  |

| vaardigheidstoets met trainingacteur  | houdt toezicht en signaleert.  |
|:---|:---|
|  *Resultaat*   | Volgens instructies gereageerd op (mogelijke) onregelmatigheden en overtredingen.  |
|  *Prestatie-Indicatoren*   | Observeert (globaal) de omgeving.  |
...
| vaardigheidstoets met trainingacteur  | treedt sanctionerend op.  |
|:---|:---|
|  *Resultaat*   | Heeft met behulp van de juiste procedures de wet gehandhaafd met de beschikbare (sanctie)middelen.  |
|  *Prestatie-Indicatoren*   | Stelt vast of het nodig is, of er een juridische grond is en of hij de bevoegdheid heeft om een sanctie op te leggen.  |
...
| vaardigheidstoets  | handelt sancties af.  |
|:---|:---|
|  *Resultaat*   | Verwerkt op juiste wijze combibon administratief.  |
|  *Prestatie-Indicatoren*   | Laat persoonlijke vooroordelen en/of relaties geen rol spelen.  |
...
####Eindtermen en gedragscomponenten openbare ruimte

| Onderwerp  | Artikel  | Toetsterm  |
|:---|:---|:---|
|  *WKPV 1.1*    [Wetboek van Strafrecht](../../../../../../wet/wet/van/3/maart/1881/BWBR0001854/README.md) *, artikelen in relatie tot de ambtenaar*   | 177 (en 177a)  | De kandidaat kan, aan de hand van een voorbeeld, aangeven of handelen of nalaten in strijd is met zijn plicht (artikel 177) of niet (artikel 177a) en of er sprake is van omkoping.  |
| 179  | De kandidaat kan aan de hand van een voorbeeld, vaststellen of er sprake is van ambtsdwang.  |
| 180  | De kandidaat kan aangeven wanneer er sprake is van verzet (artikel 180) tegen een ambtenaar.  |
| 181, 182  | De kandidaat kan aangeven wanneer er sprake is van gekwalificeerd verzet (artikel 181, 182) tegen een ambtenaar.  |
| 184  | De kandidaat kan aan de hand van een voorbeeld, aangeven wanneer er sprake is van opzettelijk niet voldoen aan een bevel of vordering krachtens wettelijk voorschrift.  |
...
| 185  | De kandidaat kan omschrijven welke mogelijkheden hij heeft volgens het wetboek van strafrecht, als iemand tijdens zijn werkzaamheden opschudding veroorzaakt en zich niet verwijdert, teneinde hem het werk onmogelijk te maken.  |
| 188  | De kandidaat kan aangeven of en wanneer er sprake is van valse aangifte.  |
| 225  | De kandidaat kan het verschil tussen valselijk opmaken en vervalsen van een geschrift opgeven en kan aangeven wanneer het gebruik van zo’n geschrift strafbaar is.  |
| 231  | De kandidaat kan benoemen dat het vervaardigen, gebruik en bezit van een vals reisdocument strafbaar is.  |
| 239  | De kandidaat kan aangeven wanneer en onder welke omstandigheden er sprake is van schennis van de eerbaarheid.  |
| 266, 267  | De kandidaat kan aangeven wat belediging is (266) en wanneer een belediging van een ambtenaar of openbaar gezag strafbaar is gedurende of terzake de rechtmatige uitoefening van zijn bediening (267).  |
| 285  | De kandidaat kan aan de hand van een voorbeeld, aangeven of en wanneer er sprake is van de verschillende in artikel 285 genoemde vormen van bedreiging.  |
| 300  | De kandidaat kan aangeven wanneer er sprake is van mishandeling.  |
| 304  | De kandidaat kan herkennen wanneer er sprake is van verzwarende omstandigheden bij mishandeling (ook: artikel 302).  |
| 350  | De kandidaat kan onderscheid maken tussen de verschillende vormen van vernieling (inclusief het doden of verwonden van een dier) zoals genoemd in artikel 350 sr.  |
| 351, 351bis  | De kandidaat kan aangeven dat het vernielen van een werk ter algemeen nut, zwaarder wordt gestraft dan een gewone vernieling en dat door schuld vernielen van een werk ter algemeen nut, afzonderlijk strafbaar is.  |
| 352  | De kandidaat kan aangeven dat het vernielen van een gebouw, vaartuig (inclusief lading), afzonderlijk strafbaar is gesteld.  |
| 416, 417 bis  | De kandidaat kan aangeven wat het verschil is tussen opzetheling en schuldheling en kan de betekenis van een voortdurend delict beschrijven.  |
| 435  | De kandidaat kan aangeven of en wanneer iemand strafbaar is voor het opgeven van valse identiteitsgegevens.  |
| 447e  | De kandidaat kan aangeven wanneer een ID bewijs kan worden gevorderd en wanneer het niet kunnen tonen van het ID bewijs, strafbaar is.  |
|  *WKPV 1.2*    *Wetboek van Strafrecht, overtredingen*   | 424  | De kandidaat kan vaststellen, gegeven een situatiebeschrijving, of er sprake is van vernieling, baldadigheid of openlijk geweld tegen goederen.  |
| 425  | De kandidaat kan aangeven, gegeven de wettekst van artikel 425 WvS, in welk geval de omgang tussen mens en een gevaarlijk dier strafbaar is gesteld.  |
| 426, 453  | De kandidaat kan aangeven welke handelingen, in staat van dronkenschap verricht, strafbaar zijn gesteld.  |
| 426bis  | De kandidaat kan vaststellen, gegeven de wettekst van artikel 426bis WvS en een situatiebeschrijving, of er sprake is van hinderlijk volgen.  |
| 427  | De kandidaat kan, gegeven de wettekst van artikel 427 WvS en een situatiebeschrijving, vaststellen of er sprake is van het in gevaar brengen van de veiligheid van verkeer op de openbare weg volgens het strafrecht.  |
| 428  | De kandidaat kan vaststellen, gegeven de wettekst van artikel 428 WvS en een situatiebeschrijving, of er sprake is van een overtreding bij het in brand steken van eigen onroerende zaken.  |
| 429  | De kandidaat kan vaststellen, gegeven de wettekst van artikel 429 WvS en een situatiebeschrijving, of er sprake is van een gevaarzettingsdelict dat als overtreding genoemd staat in het strafrecht.  |
| 430a  | De kandidaat kan benoemen onder welke voorwaarden nudisme is toegestaan volgens artikel 430 WvS.  |
| 437  | De kandidaat kan, gegeven een voorbeeld, aangeven of er sprake is van overtreding van de regels omtrent het opkopen van goederen in beroep of bedrijf.  |
| 443  | De kandidaat kan benoemen in welk geval de burgemeester een noodverordening kan afkondigen.  |
| 447b  | De kandidaat kan onderscheiden, gegeven van artikel 447b WvS, in welk geval een reisdocument moet worden ingeleverd.  |
| 458, 459, 460  | De kandidaat kan vaststellen, gegeven de wetteksten van artikelen 458, 459 en 460 WvS en een situatiebeschrijving, of er sprake is van een overtreding ten aanzien van de veldpolitie.  |
| 461  | De kandidaat kan aangeven wanneer er sprake is van verboden toegang voor onbevoegden in gevolge strafrecht.  |
|  *APV*   | –  | De kandidaat kan, aan de hand van een situatiebeschrijving, aangeven of hij binnen de APV werkzaam is als opsporingsambtenaar of toezichthouder inclusief de daarbij behorende bevoegdheden benoemen.  |
...
| –  | De kandidaat kan benoemenwat de voorwaarden zijn om te mogen collecteren, venten, als straatartiest op te treden of een standplaats innemen, binnen de gemeentelijke verordening.  |
| –  | De kandidaat kan het doel van de Waterwet aangeven inclusief de eisen die de Waterwet stelt aan het lozen van stoffen in het oppervlaktewater.  |
| –  | De kandidaat kan aangeven, gegeven de relevante wettekst, wanneer vuur stoken, en het roken in bos- en natuurgebied, strafbaar is gesteld binnen de geldende wetgeving (APV, Sr, Milieuwetgeving).  |
| –  | De kandidaat kan het onderscheid aangeven tussen de verschillende soorten afval (particulier en bedrijfsafval) inclusief in welke wetgeving dit is geregeld hij kan aangeven in welke wetgeving dit is geregeld.  |
| –  | De kandidaat kan aangeven hoe de verschillende soorten afval (particulier en bedrijfsafval) dienen te worden aangeboden ter inzameling.  |
|  [Wegenverkeerswet 1994](../../../../../../wet/wegenverkeerswet/1994/BWBR0006622/README.md)   | 1  | De kandidaat kande volgende begrippen beschrijven: wegen, motorrijtuigen, aanhangwagen, bromfiets.  |
| 2a  | De kandidaat kan aangeven in welke wet geregeld is dat de gemeenten en provincies verkeerszaken bij verordening kunnen regelen.  |
| 5  | De kandidaat kan, gegeven de relevante wettekst, aangeven wie op welke plaats strafbaar is voor gevaar c.q. hinder veroorzaken op de weg.  |
| 6  | De kandidaat kan aangeven, gegeven de relevante wettekst, wie op welke plaats strafbaar is voor dood of lichamelijk letsel door schuld in het verkeer inclusief in welke wet dit strafbaar is gesteld.  |
| 7  | De kandidaat kan aangeven, gegeven de relevante wettekst, wie op welke plaats strafbaar is voor het verlaten van de plaats ongeval inclusief in welke wet dit strafbaar is gesteld.  |
| 8  | De kandidaat kan aangeven, gegeven de relevante wettekst, wie op welke plaats strafbaar is voor rijden onder invloed inclusief in welke wet dit strafbaar is gesteld.  |
| 10  | De kandidaat kan aan de hand van een voorbeeld, gegeven de relevante wettekst, aangeven of er sprake is van het houden van wedstrijden met voertuigen op de weg.  |
| 12  | De kandidaat kan benoemen door wie en op welke wijze aanwijzingen gegeven kunnen worden aan weggebruikers, inclusief het benoemen wat de verplichtingen zijn van deze weggebruikers met betrekking tot het opvolgen van aanwijzingen.  |
| 130 lid 4, 164 lid 7, 170 t/m 174  | De kandidaat kan aangeven wanneer en op wiens last bestuursdwang is toegestaan met betrekking tot het overbrengen, wegslepen en bewaren van voertuigen inclusief wie verplicht is de kosten hiervan te voldoen.  |
|  [Reglement verkeersregels en verkeerstekens 1990](../../../../../../AMvB/reglement/verkeersregels/en/verkeerstekens/1990/(rvv/1990)/BWBR0004825/README.md)   | 5, 6, 10, 60, 62, 82  | De kandidaat kan aangeven wat de plaats op de weg is voor verschillende categorieën voertuigen.  |
| De kandidaat kan aangeven voor welke categorieën bestuurders de helmplicht op grond van het RVV, geldt.  |
|  *Vuurwerkbesluitjuncto artikel 1a van de* [Wet op de economische delicten](../../../../../../wet/wet/op/de/economische/delicten/BWBR0002063/README.md)   | 2, 3, 6  | De kandidaat kan aangeven wanneer gebruik van consumentenvuurwerk is toegestaan.  |
|  [Wet aansprakelijkheids-verzekering motorrijtuigen](../../../../../../wet/wet/aansprakelijkheidsverzekering/motorrijtuigen/BWBR0002415/README.md)   | 2  | De kandidaat kan aangeven voor welke voertuigen een verplichte aansprakelijkheidsverzekering moet worden afgesloten als met deze voertuigen aan het verkeer wordt deelgenomen.  |
|  [Wet op kansspelen](../../../../../../wet/wet/op/de/kansspelen/BWBR0002469/README.md)   | 30  | De kandidaat kan omschrijven wat de volgende begrippen inhouden: behendigheidsautomaat, speelhal, kansspelautomaat.  |
| 30a t/m 30f  | De kandidaat kan aangeven welke voorschriften en beperkingen er zijn verbonden aan het verlenen en intrekken van een vergunning voor een kansspelautomaat inclusief wie deze vergunning verleent.  |
| 30g  | De kandidaat kan aangeven wat de minimumleeftijd is voor het bespelen van een kansspelautomaat.  |
| 30t  | De kandidaat kan aangeven aan welke eisen een kansspelautomaat moet voldoen inclusief hoe hij moet controleren of een kansspelautomaat is goedgekeurd.  |
|  [Tabakswet](../../../../../../wet/tabakswet/BWBR0004302/README.md) *en* [Drank- en Horecawet](../../../../../../wet/drank-/en/horecawet/BWBR0002458/README.md)   | Tabakswet juncto art. 1 a van de WED  | De kandidaat kan aangeven wat de minimumleeftijd is van personen aan wie tabak, zwak alcoholhoudende drank en sterke drank mag worden verkocht.  |
| Drank- en Horecawet, art. 20 lid 1 en 2.  | De kandidaat kan aangeven waar het rookverbod geldt inclusief wat zijn controlebevoegdheden als toezichthouder zijn op grond van de [Algemene Wet Bestuursrecht](../../../../../../wet/algemene/wet/bestuursrecht/BWBR0005537/README.md).  |
|  [Winkeltijdenwet](../../../../../../wet/winkeltijdenwet/BWBR0007952/README.md)   | 1  | De kandidaat kan aangeven wat er, volgens de wet, verstaan wordt onder het begrip ‘winkel’.  |
| 2  | De kandidaat kan aangeven wanneer het verboden is om een winkel voor het publiek open te hebben.  |
| 3  | De kandidaat kan aangeven wie er vergunning verleent voor het openstellen van winkels voor het publiek op zon- en feestdagen.  |
|  Wet personenvervoer   | 72, 52  | De kandidaat kan, gegeven de relevante wettekst, aangeven voor wie en waar de verbodsbepaling met betrekking tot de orde, rust en veiligheid of een goede bedrijfsgang verstoren (artikel 72 Wet Personenvervoer in verband met artikel 52 van het Besluit personenvervoer) van toepassing is.  |
| 73  | De kandidaat kan, gegeven de relevante wettekst, aangeven hoe en welk soort aanwijzingen er door of vanwege de vervoerder kunnen worden gegeven en door wie ze opgevolgd moeten worden.  |
|  [Besluit personenvervoer 2000](../../../../../../AMvB/besluit/personenvervoer/2000/BWBR0011982/README.md)   | 1, 2  | De kandidaat kan omschrijven wanneer er wel of niet sprake is van openbaar vervoer volgens het besluit Personenvervoer.  |
| 41, 44, 45, 47, 48, 52, 53  | De kandidaat kan aan de hand van een casus of voorbeeld, gegeven de relevante wettekst, aangeven, of een bepaald feit /gebeurtenis valt onder de werking van de Wet Personenvervoer en het Besluit personenvervoer (artikel 41, 44, 45, 47, 48, 52 en 53).  |
|  [Wet milieubeheer](../../../../../../wet/wet/milieubeheer/BWBR0003245/README.md)   | –  | De kandidaat kan aangeven wat er, in grote lijnen, geregeld is in de Wet milieubeheer, Wet op de economische delicten en de Afvalstoffenverordening.  |
| Artikel 10.2  | De kandidaat kan aan de hand van een casus, aangeven of er sprake is van een overtreding op grond van Artikel 10.2 van de Wet milieubeheer.  |
| De kandidaat kan aan de hand van een casus, aangeven of een vrijstelling mogelijk is op grond van artikel 10.2 van de Wet milieubeheer.  |
| Artikel 10.23  | De kandidaat kan aangeven of er een verplichting is tot het vaststellen van een Afvalstoffenverordening.  |
| De kandidaat kan aangeven welk bevoegd gezag een Afvalstoffenverordening kan vaststellen.  |
| 10.30  | De kandidaat kan aangeven, aan de hand van een casus, of het ontdoen van afvalstoffen en/of -water in een voorziening voor afvalwater, strafbaar is op basis van Artikel 10.30, Wet milieubeheer.  |
| 1a en 2 van de WED  | De kandidaat kan aangeven van een strafbaar feit of dit strafbaar is gesteld in de Wet economische delicten.  |
| De kandidaat kan van een strafbaar feit aangeven of dit een misdrijf of een overtreding is.  |
| 10.1 juncto artikel 1a WED  | De kandidaat kan, op basis van een voorbeeld, aangeven wat er verwacht wordt op grond van de zorgplicht zoals omschreven in Artikel 10.1 lid 1, Wet milieubeheer juncto artikel 1a van de Wet op de economische delicten voor zover het gaat om feiten die de leefbaarheid aantasten.  |
|  [Waterwet](../../../../../../wet/waterwet/BWBR0025458/README.md)   | Artikel 6.2  | De kandidaat kan aangeven, aan de hand van een voorbeeld, of er sprake is van een strafbare gedraging als bedoeld in Artikel 6.2 lid 1 van de Waterwet, juncto artikel 1a van de Wet op de economische delicten; uitsluitend voor zover het betreft overtredingen die een nadelige invloed hebben of kunnen hebben op de leefbaarheid in de publieke ruimte.  |
|  [Wet bodem-bescherming](../../../../../../wet/wet/bodembescherming/BWBR0003994/README.md)   | 13, juncto artikel 1a van de WED  | De kandidaat kan de in deWet Bodembescherming genoemde zorgplicht omschrijven.  |
| De kandidaat kan aangeven wanneer er op grond van de Wet Bodembescherming, sprake is van het verontreinigen van de bodem.  |
|  [Visserijwet](../../../../../../wet/visserijwet/1963/BWBR0002416/README.md)   | 1, lid 1 onder c  | De kandidaat kan aangeven wat wordt verstaan onder het begrip ‘rechthebbende op het visrecht’.  |
| 1 onder 2  | De kandidaat kan aan de hand van een voorbeeld, aangeven of dit onder het begrip ‘vis’ valt, zoals omschreven in de Visserijwet.  |
| 1 onder 3  | De kandidaat kan aan de hand van een voorbeeld, aangeven of dit onder het begrip ‘vissen’ valt, zoals omschreven in de Visserijwet.  |
| 2c  | De kandidaat kan van een genoemd middel aangeven of daarmee gevist mag worden.  |
| 2a  | De kandidaat kan aangeven welke relatie er bestaat tussen de afmetingen van een vis en de handelingen die de visser mag ondernemen ten aanzien van die vis.  |
| 1 onder 4d  | De kandidaat kan een situatie herkennen waarin sprake is van binnenvisserij.  |
| 10  | De kandidaat kan aangeven wanneer een visser een visakte nodig heeft.  |
| 21  | De kandidaat kan aangeven wanneer iemand, niet zijnde een beroepsvisser, gerechtigd is om te vissen.  |
| 55  | De kandidaat kan aan de hand van een voorbeeld of casus, zijn bevoegdheden als opsporingsambtenaar benoemen (volgens artikel 55).  |
| 23  | De kandidaat kan een VISpas controleren op geldigheid.  |
| 56  | De kandidaat kan benoemen dat er binnen de sportvisserij alleen overtredingenbestaan en geen misdrijven.  |
| 61, 62  | De kandidaat kan aan de hand van een casus, zijn aanvullende bevoegdheden als opsporingsambtenaar benoemen (volgens artikel 61, 62).  |
| –  | De kandidaat kan aangeven waarom er, naast de Visserijwet, een Reglement voor de Binnenvisserij bestaat.  |
| –  | De kandidaat kan aan de hand van een casus aangeven of er ’s nachts gevist mag worden.  |
| –  | De kandidaat kan aangeven wat een visser mag die in het bezit is van een kleine VISpas.  |

| --- | --- |
|:---|:---|
|  *Kerntaak*   |  *1. Ziet toe op orde en veiligheid in het publieke domein <sup>1</sup>.*   |
|  *Werkproces*   |  *Bereidt een surveillance voor.*   |
|  *Resultaat*   | Surveillance is goed voorbereid.  |
...
|  *Prestatie-indicatoren*   | Is op tijd en aanwezig bij de briefing.  |
| Neemt informatie op en past deze gericht toe  |
| Bestudeert (indien nodig) bijbehorende wet en regelgeving.  |
| Controleert zorgvuldig de werking van materialen en middelen voordat hij op surveillance gaat (zorgt dat ze goed onderhouden zijn).  |
| Handelt volgens uitgangspunten van gemeenschappelijke veiligheidszorg  |
| Plant zelfstandig een logische en efficiënte route op basis van door hemzelf of anderen gestelde prioriteiten.  |
|  *Werkproces*   |  *Surveilleert, houdt toezicht en signaleert (on)regelmatigheden.*   |
|  *Resultaat*   | Volgens instructies gereageerd op (mogelijke) onregelmatigheden en overtredingen.  |
| Rapport is opgesteld, signalement gemaakt en doorgegeven.  |
| Nagegaan of betrokken instanties actie hebben ondernomen.  |
|  *Prestatie-Indicatoren*   | Observeert (globaal) de omgeving.  |
| Herkent/signaleert onregelmatigheden tijdig.  |
| Schat situaties die een gevaar kunnen opleveren juist in door snel veel informatie op te nemen en intensief gebruik van zijn zintuigen.  |
| Weegt op juiste wijze de risico’s af die hijzelf en anderen lopen.  |
| Concludeert correct of optreden nodig, gewenst en verantwoord is.  |
| Vraagt op tijd advies en ondersteuning.  |
| Kan zijn optreden achteraf op een verantwoorde wijze onderbouwen.  |
| Straalt door houding en voorkomen gezag uit.  |
| Spreekt burgers met overtuiging aan op ongewenst gedrag zodat zij luisteren en de aanwijzingen opvolgen.  |
| Treedt op correcte en duidelijke wijze regulerend op bij conflicten.  |
| Toont zich betrouwbaar naar collega’s en burgers.  |
| Gaat met respect om met mensen van verschillende geaardheid en culturele achtergrond.  |
| Gaat discreet om met gevoelige informatie.  |
| Bouwt een goed contact op met veel verschillende soorten mensen.  |
| Is actief en duidelijk aanwezig en aanspreekbaar.  |
| Legt duidelijk en in begrijpelijke bewoordingen aan de burger de redenen uit waarom hij hem aanspreekt.  |
| Communiceert duidelijk en volledig met bijvoorbeeld politiemedewerkers.  |
| Geeft onregelmatigheden op heldere wijze door aan instanties.  |
| Formuleert kort en bondig bij rapportages over gebeurtenissen.  |
| Verwerkt mutaties correct in een geautomatiseerd systeem.  |
| Houdt zich aan afgesproken procedures bij het uitvoeren van een surveillance.  |
| Houdt rekening met wettelijke richtlijnen in zijn contacten met het publiek.  |
|  *Kerntaak*   |  *2. Treedt op bij incidenten en calamiteiten.*   |
|  *Werkproces*   |  *Treedt corrigerend op.*   |
|  *Resultaat*   | (Voor zover mogelijk) ongewenst gedrag doen stoppen zonder te sanctioneren.  |
|  *Prestatie-Indicatoren*   | Schat de ernst van de situatie goed in.  |
| Neemt op basis van vooraf vastgestelde prioriteitstelling op heldere en duidelijke wijze de maatregelen die nodig zijn om ongewenst gedrag te stoppen  |
| Handelt de-escalerend, zodat agressie beperkt of achterwege blijft  |
| Straalt gezag uit.  |
| Reageert door houding en taalgebruik begripvol en meelevend op emoties van mensen.  |
| Laat persoonlijke vooroordelen geen rol spelen bij de benadering en opstellen van het signalement van personen.  |
| Gaat discreet om met informatie.  |
| Houdt zicht nauwgezet aan veiligheidsvoorschriften, (wettelijke) richtlijnen en de uitgangspunten van gemeenschappelijke veiligheidszorg.  |
| Houdt zijn gevoelens onder controle.  |
| Blijft effectief presteren onder druk.  |
| Reageert duidelijk en standvastig.  |
| Geeft met overtuiging aanwijzingen.  |
| Licht aanwijzingen toe met als resultaat dat het ongewenst gedrag stopt.  |
| Spreekt mensen op een de-escalerende wijze aan op ongewenst gedrag door te wijzen op de eigen verantwoordelijkheid zodat de aangesprokene de consequenties van het ongewenste gedrag inziet en het ongewenste gedrag stopt.  |
|  *Werkproces*   |  *Verleent hulp.*   |
|  *Resultaat*   | Verdere (ernstige) consequentie van het ongeval zijn voorkomen, door alert, correct en kalm optreden.  |
| Goede samenwerking met collega’s en hulpdiensten.  |
| Betrouwbare rapportage is gemaakt.  |
| Adequaat bijgedragen aan veiligheid van het publiek en het beperken van materiële en immateriële schade.  |
| De juiste hulp is op tijd geboden.  |
| Hulpdiensten zijn op tijd ingeschakeld.  |
|  *Prestatie-Indicatoren*   | Schat ernst van de situatie in en neemt de noodzakelijke maatregelen om schade zoveel mogelijk te beperken.  |
| Herkent lichamelijke stoornissen ivm vitale lichaamsfuncties en neemt de noodzakelijke eerste hulpmaatregelen.  |
| Geeft duidelijke aanwijzingen aan mensen, regelt het verkeer zodat een veilige situatie ontstaat en hulpdiensten toegang hebben.  |
| Reageert door houding en taalgebruik begripvol en meelevend.  |
| Overlegt met andere hulpverleners en maakt zonodig een taakverdeling.  |
| Roept indien nodig de hulp in van andere hulpdiensten.  |
| Neemt maatregelen om de veiligheid van betrokkenen te waarborgen.  |
| Toont respect voor de integriteit van het slachtoffer.  |
| Communiceert zorgvuldig en discreet over het slachtoffer en houdt rekening met mogelijke gevoeligheden van het slachtoffer.  |
| Houdt zicht nauwgezet aan veiligheidsvoorschriften, (wettelijke) richtlijnen en de uitgangspunten van gemeenschappelijke veiligheidszorg.  |
| Volgt instructies op in het geval politie of andere hulpdiensten de leiding hebben over het optreden.  |
| Houdt zijn gevoelens onder controle.  |
| Blijft effectief presteren onder druk.  |
|  *Werkproces*   |  *Treedt sanctionerend op.*   |
|  *Resultaat*   | Heeft met behulp van de juiste procedures de wet gehandhaafd met de beschikbare (sanctie)middelen.  |
|  *Prestatie-Indicatoren*   | Regelt, zonodig, back-up van politie, meldkamer of collega’s  |
| Stelt vast of het nodig is, of er een juridische grond is en of hij de bevoegdheid heeft om een sanctie op te leggen.  |
| Handelt op het juiste moment, overtuigend en de-escalerend  |
| Schat de ernst van het feit in, inclusief de impact op de veiligheidsgevoelens van bewoners en omstanders.  |
| Legt op duidelijke en standvastige wijze de juiste sanctie op en leidt het gesprek  |
| Geeft duidelijke uitleg over de redenen van de sanctie.  |
| Reageert rustig op agressief gedrag van de verdachte/overtreder  |
| Laat persoonlijke vooroordelen geen rol spelen bij het opleggen van een sanctie.  |
| Kiest op basis van de op te leggen sanctie de meest geschikte rapporterings- en opvolgingsdocumenten.  |
| Past procedures en wettelijke richtlijnen bij het opleggen van de sanctie correct toe.  |
| Houdt zijn gevoelens onder controle.  |
| Blijft effectief presteren onder druk.  |
| Gaat discreet om met de informatie die hij heeft over het gepleegde feit.  |
|  *Werkproces*   |  *Handelt opgelegde sancties administratief af.*   |
|  *Resultaat*   | Verwerkt op juiste wijze proces verbaal administratief.  |
|  *Prestatie-Indicatoren*   | Laat persoonlijke vooroordelen en/of relaties geen rol spelen.  |
| Gaat discreet om met de informatie die hij tot zijn beschikking heeft bij het verzamelen en verwerken van de gegevens.  |
| Verwerkt alle relevante informatie op gestructureerde wijze in het proces-verbaal.  |
| Formuleert in correct Nederlands, in begrijpelijke bewoordingen en zonder het gebruik van al te veel vakjargon.  |
| Combineert en controleert de beschikbare gegevens.  |
| Past in voorkomende situaties de voor hem van toepassing zijnde wet- en regelgeving, bevoegdheden, rechtsgebieden en bezwaarprocedures toe.  |
| Legt de van toepassing zijn wet- en regelgeving, bevoegdheden, rechtsgebieden en bezwaarprocedures zo nodig uit aan betrokkenen.  |
|  *Kerntaak*   |  *3. Voert dienstverlenende werkzaamheden uit.*   |
|  *Werkproces*   | Informeert en verwijst mensen  |
|  *Resultaat*   | Publiek, collega’s en partners zijn juist geïnformeerd of doorverwezen.  |
|  *Prestatie-Indicatoren*   | Staat mensen respectvol te woord.  |
| --- | Geeft duidelijk uitleg en controleert of hij begrepen is.  |
| --- | Speelt in op reacties van vragenstellers.  |
| --- | Straalt betrouwbaarheid en deskundigheid uit.  |
| --- | Schat afstand en tijd juist in en weet waar hij is, zodat hij het publiek goed de weg wijst.  |
| --- | Weegt af hoe ver hij kan gaan in de dienstverlening en zorgt er voor dat de veiligheid nooit in het geding komt.  |
| --- | Raadpleegt relevante informatiebronnen als hij dat nodig acht om het publiek deskundig te woord te staan.  |
| --- | Stelt open vragen om de juiste klantvraag te achterhalen.  |
| --- | Controleert bij de ‘klant’ of de vraag beantwoord is.  |
| --- | Is vriendelijk en behulpzaam.  |
| --- | Bedient de telefooncentrale, alarminstallatie, computers, portofoons en andere voorkomende hulpmiddelen op voorgeschreven, of effectieve en efficiënte wijze.  |
| --- | Voert werkzaamheden in de administratieve ondersteuning uit volgens geldende procedures en instructies.  |
|  *Werkproces*   | Voert (ondersteunende) administratieve werkzaamheden uit.  |
|  *Resultaat*   | Leidinggevende is juist geïnformeerd.  |
| --- | Heeft administratieve afhandeling juist uitgevoerd.  |
|  *Prestatie-Indicatoren*   | Rapporteert nauwkeurig en volledig aan zijn leidinggevende.  |
| --- | Schrijft in correct Nederlands een conceptreactie op door burgers ingediende bezwaren.  |
| --- | Leest de gegevens uit het bezwaarschrift nauwkeurig en begrijpt de strekking en combineert de inhoud met zijn vakkennis om reacties op bezwaren te geven.  |
| --- | Raadpleegt relevante informatiebronnen.  |
| --- | Schrijft een conceptreactie op een bezwaarschrift volgens vooraf bekende procedures.  |
|  *Werkproces*   | Geeft voorlichting.  |
|  *Resultaat*   | Doelmatig verstrekte voorlichting over veelvoorkomende criminaliteit en enig bewustzijn van de burger over zijn/haar eigen rol daarin.  |
|  *Prestatie-Indicatoren*   | Wijst personen op risicovol gedrag.  |
| --- | Draagt de eigen kennis op begrijpelijke wijze over.  |
| --- | Kan vragen over het vak duidelijk beantwoorden.  |
| --- | Benadert de toehoorders op klantvriendelijke en correcte wijze.  |
| --- | Controleert of hij de vraag van de toehoorders heeft beantwoord en of er nog openstaande vragen zijn.  |
|  *Werkproces*   | Creëert en gebruikt netwerk.  |
|  *Resultaat*   | Heeft een actief netwerk.  |
| --- | Speelt actieve rol in overleggen met andere spelers in de veiligheidsketen.  |
| --- | Heeft kennis van afspraken en beleid over belangrijke onderwerpen en communiceert deze in eigen organisatie.  |
|  *Prestatie-Indicatoren*   | Participeert in de veiligheidsketen.  |
| --- | Overlegt met, informeert op eigen initiatief en raadpleegt collega’s.  |
| --- | Legt voor zijn werk relevante contacten in de veiligheidsketen.  |
| --- | Overlegt en onderhandelt, op basis van argumenten, over aanpak en uitvoering van beleidsmaatregelen.  |
| --- | Houdt in de contacten met burgers ogen en oren open en vraagt door om de kern van de vraag van burgers te achterhalen.  |
| --- | Voldoet aan verwachtingen van burgers door ze serieus te nemen en indien nodig acties te ondernemen.  |

<sup>1</sup> De examenonderdelen en de onderliggende exameneisen zijn gebaseerd op de beroepsgerichte delen van het mbo kwalificatiedossier Toezicht en veiligheid. 
...
I.  *Uitvoerende ondersteuning bij (eenvoudige) zaken*  Bij (economische) milieudelicten (eenvoudige misdrijven en overtredingen in de zin van de [Wet op de economische delicten](../../../../../../wet/wet/op/de/economische/delicten/BWBR0002063/README.md)) kan een milieuboa zelfstandig strafrechtelijk optreden. Dit kan ter ondersteuning of in plaats van een bestuursrechtelijk handhavingstraject. Daarmee is het noodzakelijk dat de boa naast strafrechtelijke kennis, beschikt over kennis van het bestuursrecht ([AWB](../../../../../../wet/algemene/wet/bestuursrecht/BWBR0005537/README.md)).  

II.  *Deskundige ondersteuning bij gecompliceerde strafzaken*  De milieuboa verleent bij dit soort zaken voor politie of een bijzondere opsporingsdienst een belangrijke ondersteunende rol door inbreng van specialistische en/of juridische kennis over de betrokken milieuwetgeving.  

III.  *Signalerende rol bij zaken die buiten zijn opsporingsbevoegdheid of competenties vallen*  De milieuboa heeft een signalerende taak bij de uitoefening van zijn werkzaamheden. Voor zaken waarvoor hij niet bevoegd of bekwaam is, heeft hij een belangrijke oog- en oorfunctie voor de politie en/of andere bevoegde handhavinginstanties. De milieuboa registreert zijn bevindingen en maakt indien nodig een proces-verbaal van bevindingen op.  

IV.  *Terugkoppeling uitvoerbaarheid/handhaafbaarheid van normen en beleid*  De milieuboa kan problemen m.b.t. handhaafbaarheid van normen/uitvoerbaarheid van normen signaleren en doorgeven aan verantwoordelijke partijen zoals vergunningverleners, het Openbaar Ministerie en eventueel via een interne schakel aan intermediairs en ministeries die verantwoordelijk zijn voor de normstelling.   Om de hierboven beschreven opsporingstaken goed te kunnen vervullen, dient iedere milieuboa te beschikken over de volgende competenties  

####Competenties

*Vakmatige en methodischecompetenties* zijn gericht op het vermogen om op adequate wijze producten en diensten te leveren. De milieuboa kan: 
...
* integraal handhaven en bij de handhaving verder kijken dan de eigen bevoegdheden.   *Bestuurlijk-organisatorische en strategischecompetenties* zijn gericht op het plannen en regelen van het eigen werk in de context van de organisatie. De milieuboa kan: 
...
####Eindtermen en gedragscomponenten onderwijs

Voor de module wettelijk kader 1 wordt grotendeels gebruik gemaakt van de eindtermen voor de basisbekwaamheid. In de overige modules wordt gebruik gemaakt van onderstaande toetsmatrijzen.  

| Onderwerp  | Bron  | Artikel/begrip  | Toetsterm  |
|:---|:---|:---|:---|
|  *Buitegewoon opsporingsambtenaar leerplicht*   |  [Awb](../../../../../../wet/algemene/wet/bestuursrecht/BWBR0005537/README.md)   |  *Bevoegdheden:*   5.11,5.12, 5.13, 5.14, 5.15-5.20  | De kandidaat kan, aan de hand van een voorbeeld de bevoegdheden benoemen van de toezichthouder in het kader van de Algemene wet bestuursrecht  |
|  [Lpw](../../../../../../wet/leerplichtwet/1969/BWBR0002628/README.md) *en leerplicht regeling 1995*   |  *Ambtseed/ambtsbelofte en instructie*   16  | De kandidaat kan aan de hand van een voorbeeld aangeven hoe hij moet handelen conform de ambtseed/ambtsbelofte en de vastgestelde ambtsinstructie.  |
|  *Lpw*   |  *Soorten schoolverzuim*   19, 4, 4c, 21 en 21a  | De kandidaat kan, aan de hand van een voorbeeld, aangeven van welk soort schoolverzuim er sprake is.  |
|  *Lpw*   |  *Vrijstellingen*   5 onder a, juncto 7  5 onder b, juncto 8  5 onder c, juncto 9  | De kandidaat kan aangeven welke wettelijke redenen er zijn voor vrijstelling van de leerplichtwet en hij kan benoemen wie er voor de desbetreffende vrijstelling een besluit moet nemen.  |
|  *Lpw en* [besluit trekkende bevolking](../../../../../../AMvB/besluit/trekkende/bevolking/wpo/BWBR0003833/README.md)   | 5a  |
|  *Lpw*   | 11 juncto 14  11a, 12 , 13a , 3a en 3b en  15  |
|  *Lpw*   |  *Schoolinschrijvingen/ schoolbezoek*   2, ouders/verzorgers  2, jongere va 12 jaar  1b, meerderjarige jongeren  | De kandidaat kan, aan de hand van voorbeeld, aangeven wie de verantwoordelijke personen zijn betreffende schoolinschrijving en schoolbezoek.  |
|  *Lpw*   |  *Leerplicht/kwalificatieplicht*   4, 4a en 4b  | De kandidaat kan, aan de hand van een voorbeeld, aangeven of iemand leerplichtig en/of kwalificatieplichtig is.  |
|  *Lpw*   |  *Bevoegdheden hoofd school*   1, 1a, 1a1, 10, 18, 21 en 21a  | De kandidaat kan de bevoegdheden van het hoofd van de school benoemen.  |
|  *Lpw*   |  *Uitvoeren onderzoek*   22  | De kandidaat kan benoemen wanneer hij bevoegd is tot het uitvoeren van een onderzoek.  |
|  *Lpw*   |  *Overtredingen leerplichtwet*   22 en 26  | De kandidaat, kan aan de hand van een voorbeeld, aangeven of er sprake is van een overtreding van de Leerplichtwet.  |
| --- |  *Lpw*   |  *Rol onderwijsinspectie*    *27*   | De kandidaat kent de bevoegdheden van de onderwijsinspectie in het kader van de controle op de schoolhoofden  |
| --- |  [Wetboek van Strafvordering](../../../../../../wet/wet/van/15/januari/1921/BWBR0001903/README.md) *(WvSv)*   |  *Verdachte*   – begrip ‘formeel strafrecht’  – bronnen ‘formeel strafrecht’  • Wetboek van Strafvordering  • bijzondere wetten  • Wet RO  1  27, lid 1 en lid 2  • het begrip verdachte  | De kandidaat kan aangeven hoe hij een persoon als verdachte aanmerkt.  |
|  *Buitengewoon opsporingsambtenaar leerplicht*   | --- |  *Opsporingsbevoegdheid*   – begrippen  • opsporingsbevoegdheden  • toezichtbevoegdheden  • problematiek van ‘de twee petten’  – rechtmatigheid  • wetmatigheid  • proportionaliteit  • subsidiariteit  • fair play  • misbruik bevoegdheden  – gevolgen van ontbreken rechtmatig  • onrechtmatig verkregen  • onrechtmatige overheidsdaad  | De kandidaat kan, aan de hand van een voorbeeld, aangeven of de BOA leerplicht zijn opsporingsbevoegdheden rechtmatig toepast.   *N.b. 6.2.6. niet opgenomen omdat deze artikelen/activiteiten al in het begin van deze module (WKPV 1.1) aan de orde komen.*   |
| --- |  [Wet RO](../../../../../../wet/wet/op/de/rechterlijke/organisatie/BWBR0001830/README.md)    **Wetboek van Strafvordering (WvSv*)*   |  *taken OM*    *124*   • strafrechtelijke handhaving  rechtsorde en overige bij de wet vastgestelde taken  148, lid 1  • taak officier van justitie  art. 258, lid 1 en art. 261, lid 1 en 2  • dagvaarding  553  • het doen uitvoeren van rechterlijke beslissingen  | De kandidaat kan een verdachte tegen wie proces-verbaal is opgemaakt informeren over de mogelijke gevolgen daarvan op grond van kennis omtrent de taken van het openbaar ministerie.  |
| --- |  *Wet RO*   |  *Organisatie OM*   125  • College van Procureurs-generaal  • Advocaten-generaal  • Officieren van Justitie  – begrippen:  • staande magistratuur  134  • begrip ‘parket’  | De kandidaat kan een verdachte tegen wie proces-verbaal is opgemaakt informeren over de mogelijke gevolgen daarvan op grond van kennis omtrent de organisatie van het Openbaar Ministerie.  |
| --- |  [Grondwet](../../../../../../wet/grondwet/BWBR0001840/README.md) *(GW)*    *Wet RO*   |  *Procureur-generaal*   117, lid 1  • voor het leven benoemd  116  • geeft leiding aan parket Hoge Raad  111, lid 1 en lid 2 sub a en c  • taak  | De kandidaat kan een verdachte tegen wie proces-verbaal is opgemaakt informeren over de mogelijke gevolgen daarvan op grond van kennis omtrent de Procureur-generaal bij de Hoge Raad.  |
| --- |  *Wet RO*   *Wetboek van Strafvordering (WvSv*)   *Wet RO*    **Wetboek van Strafvordering (WvSv*)*    *Wet RO*   |  *Organisatie rechtspraak*    *De onderscheiden rechterlijke colleges (alleen rechtsprekende rechters)*   2  • Rechtbanken  • Gerechtshoven  • Hoge Raad  • begrip ‘zittende magistratuur’   *Hoge Raad*   72, lid 1  • begrip ‘raadsheren’  75, lid 2  • meervoudige kamer (5 leden)   *Gerechtshof*   58, lid 1  • raadsheren  411, lid 1  59, lid 1  • ressort   *rechtbanken*   40, lid 1  • rechters  268, lid 1  • meervoudige kamers (3 rechters)  41, lid 1  • arrondissement  46  • bestuur wijst rechter-commissaris aan   *enkelvoudige kamers*   51  • politierechter  53  • kinderrechter   *sector kanton*   47, lid 1 en 48, lid 1  • sector kanton  • enkelvoudige kamers (alleenrechtsprekende rechter)  • kantonrechter  | De kandidaat kan een verdachte tegen wie proces-verbaal is opgemaakt informeren over de mogelijke gevolgen daarvan op grond van kennis omtrent de organisatie van de rechtspraak.  |
| --- |  *Grondwet (GW)*    *Wet RO*    *Wetboek van Strafvordering (WvSv)*    *Wet RO*    *Wetboek van Strafvordering (WvSv)*    *Wet RO*    *Wetboek van Strafvordering(WvSv)*    *Wet RO*    *Wetboek van Strafvordering (WvSv)*   |  *De competentie van rechterlijke colleges (alleen rechtsprekende rechter) in strafzaken*    *Absolute competentie*    *• begrip*    *119*    *• Hoge Raad*    *76, lid 1*    *• ambtsmisdrijven*    *78, lid 1*    *• cassatie*    *458, eerste volzin*    *• herziening*    *Gerechtshoven*    *60, lid 1*    *• hoger beroepszaken rechtbanken (w.o. de sector kanton)*    *411, lid 2*    *• enkel- en meervoudige kamers*    *Rechtbanken*    *45, lid 1*    *• alle strafzaken*    *politierechter*    *368*    *• zaken van eenvoudige aard*    *369, lid 1*    *• maximaal een jaar gevangenisstraf*    *kinderrechter*    *– kinderzaken*    *sector kanton*    *47, lid 1*    *• kantonzaken*    *382, sub b*    *• overtredingen*    *Relatieve competentie*    *2*   | --- |
| --- |  *Grondwet (GW)*    *Wet RO*   |  *De waarborgen voor een deugdelijke rechtspraak*    *17*    *116, lid 1 en lid 2*    *• de wet wijst aan/regelt*    *Onafhankelijkheid*    *117, lid 1 en lid 4*    *• benoeming voor het leven bij koninklijk besluit*    *• rechtspositie geregeld bij wet*    *121*    *4, lid 1, 5, lid 1*    *• openbaarheid terechtzittingen*    *• vonnis gemotiveerd*    *• uitspraak openbaar*   | --- |
| --- |  *Wetboek van Strafvordering (WvSv)*   |  *De rechterlijke beslissing*    *338 en 339*    *• bewijs en bewijsmiddelen*    *344, lid 2*    *• proces-verbaal opsporingsambtenaar*    *350*    *• beraadslaging*    *351 en 352, lid 1 en de eerste volzin van lid 2*    *• veroordeling*    *• vrijspraak*    *• ontslag van rechtsvervolging*    *– begrippen:*    *• vonnis*    *• arrest*    *• hoger beroep*    *• cassatie*    *• herziening*   | --- |
| --- |  **Wetboek van Strafvordering (WvSv*)*   | 157  | De kandidaat doet het proces-verbaal toekomen aan de juiste functionaris.  |
|  *LPA*   | --- | Aanwijzing Strafrechtelijke aanpak schoolverzuim  | De kandidaat kan globaal de inhoud en de mogelijk op te leggen straffen aangeven bij verschillende verzuimsoorten.  |
| --- |  *Halt*   Factsheet HALT en schoolverzuim  Besluit aanwijzing Haltfeiten  Aanwijzing Halt afdoening  | De kandidaat kan een verwijzing naar HALT maken.  |
| --- |  *Beschikbare instrumenten*   Zorgmelding AMK  Halt verwijzing  Waarschuwing  Zorgtraject  Melding SVB  Opleggen last onder dwangsom  Proces-verbaal  | De kandidaat kan een afweging maken tussen de verschillende instrumenten van de leerplichtambtenaar en is in staat te beoordelen wanneer een proces-verbaal opgemaakt dient te worden.  |
|  *Dossiervorming*   |  [Wet bescherming persoonsgegevens](../../../../../../wet/wet/bescherming/persoonsgegevens/BWBR0011468/README.md)   |  *privacy*   | De kandidaat kent de wettelijke bepalingen rondom privacy  |
| --- |  *Wet bescherming persoonsgegevens*   |  *Verstrekken gegevens*   vrijstellingsbesluit artikel 20  | De kandidaat kent de wettelijke bepalingen rondom het verstrekken van gegevens  |
| --- | --- | Uitgaan van feiten  | De kandidaat is in staat om informatie op objectieve manier vast te leggen  |
| --- | --- | verzuimmelding, toestemmingsverklaring, aanvraagformulier vijstelling, besluiten  | De kandidaat weet welke documenten in een dossier horen  |

| vaardigheidstoets <sup>1</sup>  | bestudeert dossier (bereidt zich voor, houdt toezicht en signaleert)  |
|:---|:---|
|  *Resultaat*   | • Informatie, taak, visie en advies wat betreft de uitvoering van de werkzaamheden ontvangen/gevraagd/bestudeert.  • Volgens instructies gereageerd op (mogelijke) onregelmatigheden en overtredingen.  |
|  *Prestatie-indicatoren*   | Neemt informatie op en past deze gericht toe.  |
| Herkent/signaleert onregelmatigheden.  |
| Beoordeelt of het dossier voldoende en correcte informatie bevat.  |
| Vraagt (indien nodig) ontbrekende informatie voor het dossier op.  |
| Schat situaties die een gevaar kunnen opleveren juist in en neemt preventieve maatregelen.  |
| Bestudeert (indien nodig) bijbehorende wet en regelgeving.  |
| Stelt vast of er een juridische grond (nodig) is en of hij de bevoegdheid heeft om een sanctie op te leggen.  |
| Geeft aan hoe in gegeven situatie de proceslijn verloopt (SAS).  |

<sup>1</sup> Grijze regels zijn de exameneisen, te lezen als: De kandidaat  

| vaardigheidstoets met trainingacteur  | verhoort getuige (houdt toezicht en signaleert)  |
|:---|:---|
|  *Resultaat*   | • Volgens instructies gereageerd op (mogelijke) onregelmatigheden en overtredingen.  • Relevante aanvullende informatie verkregen voor dossier.  |
|  *Prestatie-Indicatoren*   | Observeert en interpreteert (globaal) de gedragingen en houding van de getuige.  |
| Herkent/signaleert tijdig onregelmatigheden.  |
| Schat situaties (die een gevaar kunnen opleveren) juist in, door snel veel informatie op te nemen door intensief gebruik van zijn zintuigen.  |
| Kan zijn optreden achteraf op een verantwoorde wijze onderbouwen.  |
| Straalt door houding en voorkomen gezag uit.  |
| Toont zich betrouwbaar aan de getuige.  |
| Gaat met respect om met mensen van verschillende geaardheid en culturele achtergrond.  |
| Is actief, duidelijk aanwezig en aanspreekbaar.  |
| Legt duidelijk en in begrijpelijke bewoordingen aan de getuige(n) uit waarom hij hem verhoort.  |
| Houdt zijn gevoelens onder controle.  |
| Past procedures en wettelijke richtlijnen (o.a. privacy) correct toe.  |
| Kan de waarde van de verkregen informatie aangeven.  |

| vaardigheidstoets met trainingsacteur  | verhoort verdachte (treedt sanctionerend op)  |
|:---|:---|
|  *Resultaat*   | • Heeft met behulp van de juiste procedures de wet gehandhaafd met de beschikbare (sanctie)middelen.  |
|  *Prestatie-Indicatoren*   | Legt op duidelijke en standvastige wijze de juiste sanctie op en leidt het gesprek.  |
| Geeft duidelijke uitleg over de redenen van de sanctie passend bij het niveau/ achtergrond/situatie van de verdachte.  |
| Geeft duidelijk uitleg over de gevolgen van de sanctie passend bij het niveau/ achtergrond/situatie van de verdachte. <sup>1</sup>  |
| Straalt door houding en voorkomen gezag uit.  |
| Is actief, duidelijk aanwezig en aanspreekbaar.  |
| Schat situaties (die een gevaar kunnen opleveren) juist in, door snel veel informatie op te nemen door intensief gebruik van zijn zintuigen.  |
| Neemt (indien nodig) preventieve maatregelen om agressie te voorkomen.  |
| Reageert rustig op agressief gedrag van de verdachte/overtreder.  |
| Gaat met respect om met mensen van verschillende geaardheid, culturele achtergrond en ontwikkelingsproblemen.  |
| Laat persoonlijke vooroordelen geen rol spelen bij het opleggen van een sanctie.  |
| Spreekt verdachte op het juiste niveau aan passend bij niveau/achtergrond/situatie.  |
| Stelt concrete vragen om informatie te achterhalen/controleren.  |
| Houdt zijn gevoelens onder controle.  |
| Neemt bij de situatie passende effectieve lichaamshouding aan.  |
| Blijft effectief presteren onder druk.  |
| Past procedures en wettelijke richtlijnen (o.a. privacy) bij het opleggen van de sanctie correct toe.  |
| Kan zijn optreden achteraf op een verantwoorde wijze onderbouwen.  |
| Kan aangeven welke mogelijkheden er zijn een eventueel negatieve ervaring (agressie) te verwerken.  |

<sup>1</sup> Beschrijven proceslijn (SAS): 

– uitleggen werkwijze, taken en bevoegdheden: 

– Raad voor de kinderbescherming,  

– en/of BJZ,  

– en/of William Schrikkergroep,     

– op grond van kennis omtrent: 
...
| vaardigheidstoets  | schrijft proces-verbaal (handelt sancties af)  |
|:---|:---|
|  *Resultaat*   | • Verwerkt proces-verbaal op administratief juiste wijze.  |
|  *Prestatie-Indicatoren*   | Laat persoonlijke vooroordelen en/of relaties geen rol spelen.  |
| Verwerkt alle relevante informatie op gestructureerde objectieve wijze in het proces-verbaal.  |
| Combineert en controleert de beschikbare gegevens.  |
| Past in voorkomende situaties de voor hem van toepassing zijnde wet- en regelgeving, bevoegdheden, rechtsgebieden en bezwaarprocedures toe.  |
| Past procedures en wettelijke richtlijnen correct toe.  |
| Doet het proces-verbaal toekomen aan de juiste functionaris.  |
| Kan de waarde en het doel van de afzonderlijke processen-verbaal (bevindingen en verhoor) aangeven  |
| Verwerkt alle relevante informatie in het dossier.  |

| Vaardigheidstoets  (resultaten bespreken met examinator)  | bereidt zich voor.  |
|:---|:---|
|  *Resultaat*   | • Informatie, taak, visie en advies wat betreft de uitvoering van de werkzaamheden ontvangen/gevraagd/bestudeert.  |
|  *Prestatie-indicatoren*   | Neemt informatie op en past deze gericht toe.  |
| Benoemt bij de casus (indien relevant) globaal aan met welke gedrags- en ontwikkelingsproblemen bij de verdachte spelen en wat de effecten hiervan zijn.  |
| Bestudeert (indien nodig) bijbehorende wet en regelgeving.  |
| Kan de functie van justitieel casus overleg aangeven en aangeven of en wanneer hij de desbetreffende casus kon inbrengen.  |
| Brengt de betrokken ketenpartners in kaart en geeft aan waarvoor hij ze kan benaderen.  |
| Geeft de mogelijke uitspraken en straffen van de rechter aan.  |
| Maakt een stappenplan waarin hij aangeeft hoe in de gegeven situatie gehandeld kan worden.  |

| vaardigheidstoets (in rechtbank)  | licht casus toe.  |
|:---|:---|
|  *Resultaat*   | • Opgemaakte proces-verbaal leidt tot vervolging.  • Met ketenpartners heldere afspraken gemaakt over vervolgtraject.  |
|  *Prestatie-Indicatoren*   | Vat (indien nodig) op duidelijke en standvastige wijze de casus op een kernachtige manier samen.  |
| Geeft duidelijke standvastige kernachtige antwoorden.  |
| Verdedigt belang van handhaving tactvol en diplomatiek.  |
| Kan zijn optreden op een verantwoorde wijze onderbouwen.  |
| Straalt door houding en voorkomen deskundigheid en standvastigheid uit.  |
| Toont zich betrouwbaar aan aanwezigen in de rechtbank.  |
| Stemt taal en benaderingswijze af op toehoorder (hiërarchie).  |
| Is actief, duidelijk aanwezig en aanspreekbaar.  |
| Houdt zijn gevoelens onder controle.  |
| Neemt bij de situatie passende effectieve lichaamshouding aan.  |
| Blijft effectief presteren onder druk.  |
| Past procedures en wettelijke richtlijnen (o.a. code kindermishandeling en beroepsgeheim) correct toe.  |
...
|  *12.0*    *Wederspannig-heid*   | Kennis rationele emotiviteits theorie  | Kan in de praktijk wederspannigheid herkennen en hier op een professionele manier mee omgaan door toepassing van de ret  |
...
Aanvragen om ontheffing van de bekwaamheidseis dienen door de werkgever bij de Minister van Veiligheid en Justitie (Dienst Justis) te worden ingediend. Een aanvraag om ontheffing van de bekwaamheidseis kan voor één, voor alle of voor een deel van de bij een werkgever in dienst zijnde boa’s worden gedaan. Op basis van de aanvraag wordt bij afzonderlijke beschikking dan wel bij categoriale aanwijzing een besluit genomen. Een aanvraag om ontheffing kan tegelijkertijd met de aanvraag voor een categoriale aanwijzing of voor de titel opsporingsbevoegdheid van de aanstaande boa worden ingediend. <sup> 1  Het adres van de dienst Justis is: Ministerie van Veiligheid en Justitie, Dienst JUSTIS, Juliana van Stolberglaan 10, Postbus 20300, 2500 EH ’s –Gravenhage.  </sup>  
